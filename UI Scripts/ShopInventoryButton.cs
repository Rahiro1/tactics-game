...
public class ShopInventoryButton : MonoBehaviour
{
    ...
    public TextMeshProUGUI itemName, itemDurability, itemCost, itemFavourCost, itemQuantity;
    ...
    public void DisplayItem(ShopItem shopItem)
    {
        ...
        itemFavourCost.text = shopItem.timeCost.ToString();
    ...
    {
        shopManager.OnButtonHover(this);
    }
